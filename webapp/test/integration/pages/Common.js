sap.ui.define([
	...
	return Opa5.extend("sap.teched.fioritoolsfreestylenorthwind.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["sap/teched/fioritoolsfreestylenorthwind/localService/mockserver"], function (mockserver) {
