sap.ui.define([
	"sap/ui/test/Opa5",
	"sap/teched/fioritoolsfreestylenorthwind/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("sap.teched.fioritoolsfreestylenorthwind.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "sap.teched.fioritoolsfreestylenorthwind",
					async: true
				},
				hash: oOptions.hash,
