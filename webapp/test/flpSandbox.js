					...
					"config": {
						"inbounds": {
							"ManageProducts-display": {
								...
								"action": "display",
								"description": "Fiori tools freestyle northwind app",
								"title": "Manage Products",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.teched.fioritoolsfreestylenorthwind",
									"url": sap.ui.require.toUrl("sap/teched/fioritoolsfreestylenorthwind")
								}
							}
						}
					}
