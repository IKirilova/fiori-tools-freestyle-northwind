sap.ui.define([
	...
	return BaseController.extend("sap.teched.fioritoolsfreestylenorthwind.controller.Worklist", {
		...
		onFilterSelect: function(oEvent){
			...
			// get the filter that needs to be added to the request
			var oFilter = this._createFilterByTabKey(sKey);

			// get the items aggreation from table 
		...
		_createFilterByTabKey(sKey){
			switch (sKey){
				...
				case "OutOfStock":
					// out of stock is when we have 0 items in stock
					return new Filter("UnitsInStock", FilterOperator.EQ, 0);
				default:
					return [];
			}
		}
